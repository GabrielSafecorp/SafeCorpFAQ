        ...
        <div class="uk-container">
            <div class="uk-grid-medium" uk-grid>
                <div class="uk-width-3-4@m uk-flex-last@m">
                    <h1>{{$module->title}}</h1>
                    <p class="uk-text-lead uk-margin-medium-bottom">{{$module->description}}</p>
                    ...
                    <li><a @if ($module->id > (1)) href="../modules/{{$module->id - (1)}}" @endif><span class="uk-margin-small-right" uk-pagination-previous></span> Previous</a></li>
                    <li class="uk-margin-auto-left">
                        <a  @if ($module->id < $count)
                            href="../modules/{{$module->id + (1)}}" @endif> Next <span class="uk-margin-small-left" uk-pagination-next></span></a></li>
                    </ul>
                </div>
                <div class="uk-width-1-4@m text-dark sidebar">
                    <h3>Categories</h3>
                    <ul class="uk-list uk-list-large uk-margin-medium-bottom">
                        {{-- Mostrando Menus  Modulus -> show.blade.php                         --}}
